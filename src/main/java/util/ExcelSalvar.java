...
public class ExcelSalvar {
	...
	public static void main(String[] args) throws IOException {
		...
		listaCampos.add(new Campo(1, 1, "www", "Campo 01", 1, 1));
		listaCampos.add(new Campo(2, 4, "www", "Campo 01", 1, 1));
		ExcelSalvar.salvarDadosExcel(listaCampos);*/
	}

	public static void salvarDadosCampos(List<Campo>  listaCampos) {
